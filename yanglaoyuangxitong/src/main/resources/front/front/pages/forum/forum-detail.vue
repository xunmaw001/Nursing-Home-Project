<template>
	<view>
        ...
        <view class="username">
			<text v-if="forum.yishengId != null">
				 发布人：{{forum.yishengName}}（医生）
			</text>
			...
			<view class="uni-article__comment-box" v-for="comment in commentData" :key="comment.id" >
				<view class="article-meta">
					<view class="article-header-image">
                        <image v-if="comment.yishengId != null" class="image" :src="baseUrl+comment.yishengPhoto" mode="widthFix"></image>
					...
					<view class="article-header-content">
						<view class="article-header-title">
							<text v-if="comment.yishengId != null">{{comment.yishengName}}</text>
