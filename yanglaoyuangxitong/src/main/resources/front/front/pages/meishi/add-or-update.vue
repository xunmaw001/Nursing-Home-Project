        ...
        <form class="app-update-pv">
            <view
                ...
                <input   disabled
                         ...
                         :disabled="ro.meishiName" type="text" v-model="ruleForm.meishiName" placeholder="餐食名称"></input>
            </view>
                ...
                <view
                    ...
                    <view class="right-input" style="padding:0;textAlign:left">
                        <image
                                ...
                                class="avator" v-if="ruleForm.meishiPhoto" :src="baseUrl+ruleForm.meishiPhoto" mode="aspectFill">
                        </image>
            ...
            <view
                ...
                <textarea :style='{"padding":"0 30rpx","boxShadow":"0 0 0px rgba(0,0,0,.6) inset","margin":"0","borderColor":"var(--publicMainColor)","backgroundColor":"#fff","color":"rgba(0, 0, 0, 1)","textAlign":"left","borderRadius":"0","borderWidth":"10rpx 2rpx","fontSize":"28rpx","borderStyle":"solid","height":"88rpx","marginTop":"7rpx","height":"200rpx"}'
                          :disabled="ro.meishiContent" v-model="ruleForm.meishiContent" placeholder="餐食介绍"/>
            </view>
        ...
        methods: {
            ...
            async onSubmitTap() {
				if ((!this.ruleForm.meishiName)) {
                    this.$utils.msg(`餐食名称不能为空`);
                    return
                }
				if ((!this.ruleForm.meishiPhoto)) {
                    this.$utils.msg(`餐食封面不能为空`);
                    return
                }
                if (this.ruleForm.id) {
