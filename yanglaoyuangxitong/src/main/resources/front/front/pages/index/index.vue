...
<view class="pl15 col3 header-title" style="padding: 0 12px;box-sizing: border-box;" :style='{"backgroundColor":"var(--publicSubColor)","borderColor":"var(--publicMainColor)","color":"rgba(255, 255, 255, 1)","borderRadius":"200rpx","borderWidth":"4rpx","fontSize":"32rpx","lineHeight":"72rpx","borderStyle":"dashed"}'>
    ...
    <view @tap="onDetailTap('news',item.id)" v-for="(item,index) in newsList" :key="index" class="list-item"
          :style='{"padding":"20rpx 12rpx","boxShadow":"0 10rpx 0px 4rpx var(--publicMainColor)","margin":"20rpx auto","borderColor":"var(--publicSubColor)","backgroundColor":"rgba(255,255,255,1)","borderRadius":"0 0 40rpx 40rpx","borderWidth":"2rpx","width":"46%","borderStyle":"solid","height":"auto"}'
          style="display: flex;flex-wrap: wrap;">
        <view
        ...
        <view
                :style='{"padding":"0","boxShadow":"0 0 12rpx rgba(255,0,0,0)","margin":"16rpx 0 0","borderColor":"red","backgroundColor":"rgba(255,0,0,0)","color":"rgba(126, 126, 126, 1)","textAlign":"left","borderRadius":"0","borderWidth":"0","width":"100%","lineHeight":"36rpx","fontSize":"24rpx","borderStyle":"solid"}'
                class="category hide2" v-html="item.newsContent">
        </view>
        <view
                :style='{"padding":"0","boxShadow":"0 0 12rpx rgba(255,0,0,0)","margin":"16rpx 0 0","borderColor":"red","backgroundColor":"rgba(255,0,0,0)","color":"rgba(126, 126, 126, 1)","textAlign":"right","borderRadius":"0","borderWidth":"0","width":"50%","lineHeight":"36rpx","fontSize":"24rpx","borderStyle":"solid"}'
...
<view class="pl15 col3 header-title" style="padding: 0 12px;box-sizing: border-box;" :style='{"backgroundColor":"var(--publicSubColor)","borderColor":"var(--publicMainColor)","color":"rgba(255, 255, 255, 1)","borderRadius":"200rpx","borderWidth":"4rpx","fontSize":"32rpx","lineHeight":"72rpx","borderStyle":"dashed"}'>
    ...
    <view class="right-content" @tap="onPageTap('fuwuxiangmu')" :style="{fontSize:'32rpx',color:'#FFF'}">
        查看更多
    </view>
</view>
<view class="list-box style3"
      :style='{"padding":"20rpx 24rpx","boxShadow":"0 2rpx 12rpx rgba(0,0,0,0)","margin":"0","borderColor":"rgba(0,0,0,0)","backgroundColor":"rgba(228, 228, 228, 1)","borderRadius":"0","borderWidth":"0","width":"100%","borderStyle":"solid","height":"auto"}'>
    <view @tap="onDetailTap('fuwuxiangmu',product.id)" v-for="(product,index) in fuwuxiangmuList"
          :key="index" class="list-item"
          :style='{"padding":"0 20rpx","boxShadow":"0 0px 0px rgba(0,0,0,.3)","margin":"0 0 20rpx","borderColor":"var(--publicMainColor)","backgroundColor":"#fff","borderRadius":"20rpx","borderWidth":"4rpx","width":"100%","borderStyle":"solid","height":"auto"}'>
        <image
                :style='{"padding":"0","boxShadow":"0 2rpx 12rpx rgba(0,0,0,0)","margin":"0","borderColor":"var(--publicMainColor)","backgroundColor":"rgba(0,0,0,0)","borderRadius":"0","borderWidth":"0 4rpx","width":"60%","borderStyle":"solid","height":"160rpx"}'
                class="list-item-image" mode="aspectFill"
                :src="baseUrl+product.fuwuxiangmuPhoto"></image>
        <view class="list-item-body"
              :style='{"padding":"0","boxShadow":"0 2rpx 12rpx rgba(0,0,0,0)","margin":"0","borderColor":"rgba(0,0,0,0)","backgroundColor":"#fff","borderRadius":"0","borderWidth":"0","width":"40%","borderStyle":"solid","height":"auto"}'>
            <view
                    ...
                    class="list-item-title">{{product.fuwuxiangmuName}}
            </view>
        </view>
    </view>
</view>
...
<view class="pl15 col3 header-title" style="padding: 0 12px;box-sizing: border-box;" :style='{"backgroundColor":"var(--publicSubColor)","borderColor":"var(--publicMainColor)","color":"rgba(255, 255, 255, 1)","borderRadius":"200rpx","borderWidth":"4rpx","fontSize":"32rpx","lineHeight":"72rpx","borderStyle":"dashed"}'>
    ...
    <view class="right-content" @tap="onPageTap('meishi')" :style="{fontSize:'32rpx',color:'#FFF'}">
        查看更多
    </view>
</view>
<view class="list-box style3"
      :style='{"padding":"20rpx 24rpx","boxShadow":"0 2rpx 12rpx rgba(0,0,0,0)","margin":"0","borderColor":"rgba(0,0,0,0)","backgroundColor":"rgba(228, 228, 228, 1)","borderRadius":"0","borderWidth":"0","width":"100%","borderStyle":"solid","height":"auto"}'>
    <view @tap="onDetailTap('meishi',product.id)" v-for="(product,index) in meishiList"
          :key="index" class="list-item"
          :style='{"padding":"0 20rpx","boxShadow":"0 0px 0px rgba(0,0,0,.3)","margin":"0 0 20rpx","borderColor":"var(--publicMainColor)","backgroundColor":"#fff","borderRadius":"20rpx","borderWidth":"4rpx","width":"100%","borderStyle":"solid","height":"auto"}'>
        <image
                :style='{"padding":"0","boxShadow":"0 2rpx 12rpx rgba(0,0,0,0)","margin":"0","borderColor":"var(--publicMainColor)","backgroundColor":"rgba(0,0,0,0)","borderRadius":"0","borderWidth":"0 4rpx","width":"60%","borderStyle":"solid","height":"160rpx"}'
                class="list-item-image" mode="aspectFill"
                :src="baseUrl+product.meishiPhoto"></image>
        <view class="list-item-body"
              :style='{"padding":"0","boxShadow":"0 2rpx 12rpx rgba(0,0,0,0)","margin":"0","borderColor":"rgba(0,0,0,0)","backgroundColor":"#fff","borderRadius":"0","borderWidth":"0","width":"40%","borderStyle":"solid","height":"auto"}'>
            <view
                    :style='{"padding":"10rpx 10rpx 0","boxShadow":"0 2rpx 12rpx rgba(0,0,0,0)","margin":"0 auto","borderColor":"rgba(0,0,0,0)","backgroundColor":"rgba(0,0,0,0)","color":"rgba(0, 0, 0, 1)","textAlign":"left","borderRadius":"0","borderWidth":"0","width":"100%","lineHeight":"40rpx","fontSize":"28rpx","borderStyle":"solid"}'
                    class="list-item-title">{{product.meishiName}}
            </view>
        </view>
    </view>
</view>
...
<view class="pl15 col3 header-title" style="padding: 0 12px;box-sizing: border-box;" :style='{"backgroundColor":"var(--publicSubColor)","borderColor":"var(--publicMainColor)","color":"rgba(255, 255, 255, 1)","borderRadius":"200rpx","borderWidth":"4rpx","fontSize":"32rpx","lineHeight":"72rpx","borderStyle":"dashed"}'>
    ...
    <view class="right-content" @tap="onPageTap('yisheng')" :style="{fontSize:'32rpx',color:'#FFF'}">
        查看更多
    </view>
</view>
<view class="list-box style3"
      :style='{"padding":"20rpx 24rpx","boxShadow":"0 2rpx 12rpx rgba(0,0,0,0)","margin":"0","borderColor":"rgba(0,0,0,0)","backgroundColor":"rgba(228, 228, 228, 1)","borderRadius":"0","borderWidth":"0","width":"100%","borderStyle":"solid","height":"auto"}'>
    <view @tap="onDetailTap('yisheng',product.id)" v-for="(product,index) in yishengList"
          :key="index" class="list-item"
          :style='{"padding":"0 20rpx","boxShadow":"0 0px 0px rgba(0,0,0,.3)","margin":"0 0 20rpx","borderColor":"var(--publicMainColor)","backgroundColor":"#fff","borderRadius":"20rpx","borderWidth":"4rpx","width":"100%","borderStyle":"solid","height":"auto"}'>
        <image
                :style='{"padding":"0","boxShadow":"0 2rpx 12rpx rgba(0,0,0,0)","margin":"0","borderColor":"var(--publicMainColor)","backgroundColor":"rgba(0,0,0,0)","borderRadius":"0","borderWidth":"0 4rpx","width":"60%","borderStyle":"solid","height":"160rpx"}'
                class="list-item-image" mode="aspectFill"
                :src="baseUrl+product.yishengPhoto"></image>
        <view class="list-item-body"
              :style='{"padding":"0","boxShadow":"0 2rpx 12rpx rgba(0,0,0,0)","margin":"0","borderColor":"rgba(0,0,0,0)","backgroundColor":"#fff","borderRadius":"0","borderWidth":"0","width":"40%","borderStyle":"solid","height":"auto"}'>
            <view
                    :style='{"padding":"10rpx 10rpx 0","boxShadow":"0 2rpx 12rpx rgba(0,0,0,0)","margin":"0 auto","borderColor":"rgba(0,0,0,0)","backgroundColor":"rgba(0,0,0,0)","color":"rgba(0, 0, 0, 1)","textAlign":"left","borderRadius":"0","borderWidth":"0","width":"100%","lineHeight":"40rpx","fontSize":"28rpx","borderStyle":"solid"}'
                    class="list-item-title">{{product.yishengName}}
            </view>
        </view>
    </view>
</view>
...
<script>
    ...
    export default {
        ...
        async onShow() {
            ...
            let fuwuxiangmu = await this.$api.list('fuwuxiangmu', {
                page: 1,
                limit: 6,
                yonghuDelete: 1,
                });

            this.fuwuxiangmuList = fuwuxiangmu.data.list
            this.fuwuxiangmuList.forEach(function(item, index) {
                if(item.fuwuxiangmuContent != null && item.fuwuxiangmuContent != "" && item.fuwuxiangmuContent != "null"){
                    item.fuwuxiangmuContent =item.fuwuxiangmuContent.replace(/<img [^>]*src=['"]([^'"]+)[^>]*>/gi,"");//替换图片
                }
            });
            ...
            this.meishiList.forEach(function(item, index) {
                if(item.meishiContent != null && item.meishiContent != "" && item.meishiContent != "null"){
                    item.meishiContent =item.meishiContent.replace(/<img [^>]*src=['"]([^'"]+)[^>]*>/gi,"");//替换图片
                }
            });
            ...
            let yisheng = await this.$api.requestCondition('yisheng','gexingtuijian',val);

            this.yishengList = yisheng.data.list
            this.yishengList.forEach(function(item, index) {
                if(item.yishengContent != null && item.yishengContent != "" && item.yishengContent != "null"){
                    item.yishengContent =item.yishengContent.replace(/<img [^>]*src=['"]([^'"]+)[^>]*>/gi,"");//替换图片
                }
            });
