    ...
    <div class="addEdit-block">
        ...
        >
            <el-row>
                ...
                <el-col :span="12">
                    <el-form-item class="input" v-if="type!='info'"  label=" " prop="indexName">
                        <el-input v-model="ruleForm.indexName"
                                  placeholder=" " clearable  :readonly="ro.indexName"></el-input>
                    </el-form-item>
                    <div v-else>
                        <el-form-item class="input" label=" " prop="indexName">
                            <el-input v-model="ruleForm.indexName"
            ...
            init(id,type) {
                ...
                if(this.type=='info'||this.type=='else'){
                    ...
                    this.$http({
                        ...
                        method: "post",
                        data: {"dicCode":"fuwuxiangmu_yuyue_yesno_types"}
                    }).then(({ data }) => {
                        if (data && data.code === 0) {
            ...
            onSubmit() {
                ...
                this.$refs["ruleForm"].validate(valid => {
                    if (valid) {
                        ...
                        ruleForm["dicCode"]="fuwuxiangmu_yuyue_yesno_types";
                        ruleForm["dicName"]=" ";
                        this.$http({
