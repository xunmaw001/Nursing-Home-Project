    ...
    <div>
        <div class="container">
            <div class="login-form">
                <h1 class="h1" style="color:#000;fontSize:28px;">微信小程序养老院系统注册</h1>
                <el-form class="rgs-form">
                    ...
                    <el-form-item label="重复密码" class="input">
                        ...
                        -->
                        <!--
                            <el-form-item label="挂号人数限制" class="input" v-if="tableName=='yisheng'">
                                <el-input v-model="ruleForm.yishengNumber" autocomplete="off" placeholder="挂号人数限制"  />
                           </el-form-item>
                        -->
                        <!--
                            <el-form-item label="挂号价格" class="input" v-if="tableName=='yisheng'">
                                <el-input v-model="ruleForm.yishengNewMoney" autocomplete="off" placeholder="挂号价格"  />
                           </el-form-item>
                        -->
                        <!--
                            <el-form-item label="在诊日期" class="input" v-if="tableName=='yisheng'">
                                <el-input v-model="ruleForm.yishengTime" autocomplete="off" placeholder="在诊日期"  />
                           </el-form-item>
                        -->
                        <!--
                            <el-form-item label="职称" class="input" v-if="tableName=='yisheng'">
                                <el-input v-model="ruleForm.yishengZhicheng" autocomplete="off" placeholder="职称"  />
                           </el-form-item>
                        -->
                        <!--
                            <el-form-item label="医生简介" class="input" v-if="tableName=='yisheng'">
                                <el-input type="textarea" v-model="ruleForm.yishengContent" placeholder="医生简介"></el-input>
                           </el-form-item>
                        -->
                        <!--
                            <el-form-item label="逻辑删除" class="input" v-if="tableName=='yisheng'">
                                <el-input v-model="ruleForm.yishengDelete" autocomplete="off" placeholder="逻辑删除"  />
                           </el-form-item>
                        -->
                        <!--
                            <el-form-item label="添加时间" class="input" v-if="tableName=='yisheng'">
                        ...
                        <!--
                            <el-form-item label="现有余额" class="input" v-if="tableName=='yonghu'">
    ...
    export default {
        ...
        methods: {
            ...
            login() {
                            ...
                            //     return
                            // }
                            // yisheng 中的 挂号人数限制 判空处理
                            // if('yisheng' == this.tableName && (this.ruleForm.yishengNumber== null ||this.ruleForm.yishengNumber== "")){
                            //     this.$message.error("挂号人数限制不能为空");
                            //     return
                            // }
                            // yisheng 中的 挂号价格 判空处理
                            // if('yisheng' == this.tableName && (this.ruleForm.yishengNewMoney== null ||this.ruleForm.yishengNewMoney== "")){
                            //     this.$message.error("挂号价格不能为空");
                            //     return
                            // }
                            // yisheng 中的 在诊日期 判空处理
                            // if('yisheng' == this.tableName && (this.ruleForm.yishengTime== null ||this.ruleForm.yishengTime== "")){
                            //     this.$message.error("在诊日期不能为空");
                            //     return
                            // }
                            // yisheng 中的 职称 判空处理
                            // if('yisheng' == this.tableName && (this.ruleForm.yishengZhicheng== null ||this.ruleForm.yishengZhicheng== "")){
                            //     this.$message.error("职称不能为空");
                            //     return
                            // }
                            // yisheng 中的 医生简介 判空处理
                            // if('yisheng' == this.tableName && (this.ruleForm.yishengContent== null ||this.ruleForm.yishengContent== "")){
                            //     this.$message.error("医生简介不能为空");
                            //     return
                            // }
                            // yisheng 中的 逻辑删除 判空处理
                            // if('yisheng' == this.tableName && (this.ruleForm.yishengDelete== null ||this.ruleForm.yishengDelete== "")){
                            //     this.$message.error("逻辑删除不能为空");
                            //     return
                            // }
                            // yisheng 中的 添加时间 判空处理
                            // if('yisheng' == this.tableName && (this.ruleForm.insertTime== null ||this.ruleForm.insertTime== "")){
...
<style lang="scss" scoped>
	...
	.container {
		...
		background-image: url(/yanglaoyuangxitong/img/back-img-bg.jpg);
