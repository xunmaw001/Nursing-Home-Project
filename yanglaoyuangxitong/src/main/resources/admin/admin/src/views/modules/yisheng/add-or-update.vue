    ...
    <div class="addEdit-block">
        <el-form
            ...
            <el-row>
               ...
               <el-col :span="12">
                   <el-form-item class="input" v-if="type!='info'"  label="挂号人数限制" prop="yishengNumber">
                       <el-input v-model="ruleForm.yishengNumber"
                                 placeholder="挂号人数限制" clearable  :readonly="ro.yishengNumber"></el-input>
                   </el-form-item>
                   <div v-else-if="type=='info'">
                       <el-form-item class="input" label="挂号人数限制" prop="yishengNumber">
                           <el-input v-model="ruleForm.yishengNumber"
                                     placeholder="挂号人数限制" readonly></el-input>
                       </el-form-item>
                   </div>
               </el-col>
               <el-col :span="12">
                ...
                <el-col :span="12">
                    <el-form-item v-if="type!='info'"  class="input" label="在诊日期" prop="yishengTime">
                        <el-date-picker
                                value-format="yyyy-MM-dd HH:mm:ss"
                                v-model="ruleForm.yishengTime"
                                type="datetime"
                                placeholder="在诊日期"
                                :disabled="ro.yishengTime">
                        </el-date-picker>
                    </el-form-item>
                    <div v-else-if="type=='info'">
                        <el-form-item v-if="ruleForm.yishengTime" label="在诊日期" prop="yishengTime">
                            <span v-html="ruleForm.yishengTime"></span>
                        </el-form-item>
                    </div>
                </el-col>
               ...
               <el-col :span="12">
                ...
                <el-col :span="24">
                    <el-form-item v-if="type!='info'"  label="医生简介" prop="yishengContent">
                    ...
                    <div v-else-if="type=='info'">
                        <el-form-item v-if="ruleForm.yishengContent" label="医生简介" prop="yishengContent">
        ...
        data() {
            return {
                ...
                rules: {
                   ...
                   yishengNumber: [
                              { required: true, message: '挂号人数限制不能为空', trigger: 'blur' },
                              {  pattern: /^[0-9]*$/,
                                  message: '只允许输入整数',
                                  trigger: 'blur'
                              }
                   ...
                   yishengTime: [
                              { required: true, message: '在诊日期不能为空', trigger: 'blur' },
                          ],
                   yishengZhicheng: [
