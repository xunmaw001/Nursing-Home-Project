    ...
    <div class="addEdit-block">
        <el-form
            ...
            <el-row>
               ...
               <el-col :span="12">
                   <el-form-item class="input" v-if="type!='info'"  label="编号" prop="yishengOrderUuidNumber">
                       <el-input v-model="ruleForm.yishengOrderUuidNumber"
                                 placeholder="编号" clearable  :readonly="ro.yishengOrderUuidNumber"></el-input>
                   </el-form-item>
                   <div v-else-if="type=='info'">
                       <el-form-item class="input" label="编号" prop="yishengOrderUuidNumber">
                           <el-input v-model="ruleForm.yishengOrderUuidNumber"
            ...
            <input id="yonghuId" name="yonghuId" type="hidden">
                <el-col :span="12">
                    <el-form-item v-if="type!='info'"  class="input" label="挂号日期" prop="yishengOrderTime">
                        <el-date-picker
                                value-format="yyyy-MM-dd"
                                v-model="ruleForm.yishengOrderTime"
                                type="date"
                                placeholder="挂号日期"
                                :disabled="ro.yishengOrderTime">
                        </el-date-picker>
                    </el-form-item>
                    <div v-else-if="type=='info'">
                        <el-form-item v-if="ruleForm.yishengOrderTime" label="挂号日期" prop="yishengOrderTime">
                            <span v-html="ruleForm.yishengOrderTime"></span>
                        </el-form-item>
                    </div>
                </el-col>

                <el-col :span="12">
                    <el-form-item class="select" v-if="type!='info'"  label="挂号时间段" prop="shijianduanTypes">
                        <el-select v-model="ruleForm.shijianduanTypes" :disabled="ro.shijianduanTypes" placeholder="请选择挂号时间段">
                            <el-option
                    ...
                    <div v-else-if="type=='info'">
                        <el-form-item class="input" label="挂号时间段" prop="shijianduanValue">
                        <el-input v-model="ruleForm.shijianduanValue"
                            placeholder="挂号时间段" readonly></el-input>
                        </el-form-item>
                    </div>
                </el-col>
               <el-col :span="12">
                ...
                <el-col :span="12">
                    <el-form-item class="select" v-if="type!='info'"  label="订单类型" prop="yishengOrderTypes">
                        <el-select v-model="ruleForm.yishengOrderTypes" :disabled="ro.yishengOrderTypes" placeholder="请选择订单类型">
                            <el-option
                    ...
                    <div v-else-if="type=='info'">
                        <el-form-item class="input" label="订单类型" prop="yishengOrderValue">
        ...
        data() {
            return {
                ...
                rules: {
                   ...
                   shijianduanTypes: [
                              { required: true, message: '挂号时间段不能为空', trigger: 'blur' },
                              {  pattern: /^[0-9]*$/,
                                  message: '只允许输入整数',
                                  trigger: 'blur'
                              }
