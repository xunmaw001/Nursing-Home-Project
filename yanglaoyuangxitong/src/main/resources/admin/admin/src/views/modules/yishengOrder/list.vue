        ...
        <div v-if="showFlag">
            <el-form :inline="true" :model="searchForm" class="form-content">
                <el-row :gutter="20" class="slt" :style="{justifyContent:contents.searchBoxPosition=='1'?'flex-start':contents.searchBoxPosition=='2'?'center':'flex-end'}">
                     ...
                     <el-form-item :label="contents.inputTitle == 1 ? '编号' : ''">
                         <el-input prefix-icon="el-icon-search" v-model="searchForm.yishengOrderUuidNumber" placeholder="编号" clearable></el-input>
                     </el-form-item>
                                                 
                     <el-form-item :label="contents.inputTitle == 1 ? '订单类型' : ''">
                        <el-select v-model="searchForm.yishengOrderTypes" placeholder="请选择订单类型">
                ...
                <el-row class="ad" :style="{justifyContent:contents.btnAdAllBoxPosition=='1'?'flex-start':contents.btnAdAllBoxPosition=='2'?'center':'flex-end'}">
                    <el-form-item>
                        ...
                        <a style="text-decoration:none" class="el-button el-button--success"
                           ...
                           href="http://localhost:8080/yanglaoyuangxitong/upload/yishengOrderMuBan.xls"
                        >批量导入挂号订单数据模板</a>
                        &nbsp;
                        <el-upload
                                v-if="isAuth('yishengOrder','导入导出')"
            ...
            <div class="table-content">
                <el-table class="tables" :size="contents.tableSize" :show-header="contents.tableShowHeader"
                    ...
                    <el-table-column  :sortable="contents.tableSortable" :align="contents.tableAlign"
                                   prop="yishengOrderTime"
                                   header-align="center"
                                   label="挂号日期">
                        <template slot-scope="scope">
                            {{scope.row.yishengOrderTime}}
                        </template>
                    </el-table-column>
                    <el-table-column  :sortable="contents.tableSortable" :align="contents.tableAlign"
            ...
            <el-button v-if="isAuth('yishengOrder','订单') && scope.row.yishengOrderTypes == 101 && sessionTable=='yonghu' && userId==scope.row.yonghuId" type="primary" icon="el-icon-sold-out" size="mini" @click="refund(scope.row.id)">取消</el-button>
            <el-button v-if="isAuth('yishengOrder','订单') && scope.row.yishengOrderTypes == 101
&& sessionTable=='yisheng'" type="primary" icon="el-icon-reading" size="mini"
    ...
    //当前表下拉框搜索条件
            ...
            json_fields: {
                //级联表字段
                     ...
                     '现有余额': 'newMoney',
                //本表字段
                     '编号': "yishengOrderUuidNumber",
                     '挂号日期': "yishengOrderTime",
                     '挂号时间段': "shijianduanValue",
                     '实付价格': "yishengOrderTruePrice",
                     '订单类型': "yishengOrderValue",
                     '订单创建时间': "insertTime",
            },
