  ...
  <div>
    ...
    >  
     <el-row>
         ...
         <el-col :span="12">
           <el-form-item v-if="flag=='yisheng'"  label='挂号人数限制' prop="yishengNumber">
               <el-input v-model="ruleForm.yishengNumber"  placeholder='挂号人数限制' clearable></el-input>
           </el-form-item>
         </el-col>

         <el-col :span="12">
             <el-form-item v-if="flag=='yisheng'"  label='挂号价格' prop="yishengNewMoney">
                 <el-input v-model="ruleForm.yishengNewMoney"  placeholder='挂号价格' disabled style="width: 100px"></el-input>
         ...
         <el-col :span="24">
             <el-form-item v-if="flag=='yisheng'"  label="医生简介" prop="yishengContent">
                 <editor
...
// 注册表 医生 的级联表
  ...
  methods: {
    ...
    onUpdateHandler() {
                         ...
                         if((!this.ruleForm.yishengNumber)&& 'yisheng'==this.flag){
                             this.$message.error('挂号人数限制不能为空');
                             return
                         }

                         if((!this.ruleForm.yishengNewMoney)&& 'yisheng'==this.flag){
